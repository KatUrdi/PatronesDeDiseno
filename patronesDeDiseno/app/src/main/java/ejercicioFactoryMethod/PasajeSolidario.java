package factoryMethod.ejercicioFactoryMathod;

public class PasajeSolidario implements Pasaje1{
    ...
    public void compraPasaje() {
        System.out.println("Se realizo la compra de un pasaje solidario exitosamente");
